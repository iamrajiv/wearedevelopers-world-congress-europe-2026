...
// SayHelloRequest contains the user's name
...
const file_hello_v1_hello_proto_rawDesc = "" +
	...
	"\bSayHello\x12\x19.hello.v1.SayHelloRequest\x1a\x1a.hello.v1.SayHelloResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/helloB\xc5\x01\n" +
	"\fcom.hello.v1B\n" +
	"HelloProtoP\x01Zhgithub.com/iamrajiv/wearedevelopers-world-congress-europe-2026/examples/hello/gen/proto/hello/v1;hellov1\xa2\x02\x03HXX\xaa\x02\bHello.V1\xca\x02\bHello\\V1\xe2\x02\x14Hello\\V1\\GPBMetadata\xea\x02\tHello::V1b\x06proto3"
